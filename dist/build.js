"bundle";
System.register('app/index/Hodler.js', ['npm:babel-runtime@5.8.38/helpers/create-class.js', 'npm:babel-runtime@5.8.38/helpers/class-call-check.js', 'npm:jquery@2.2.2.js', 'app/index/BgImg.js', 'app/util/img.js'], function (_export) {
    var _createClass, _classCallCheck, $, BgImg, checkLoad, Hodler;
    ...
    return {
        ...
        }, function (_npmJquery222Js) {
            $ = _npmJquery222Js['default'];
        }, function (_appIndexBgImgJs) {
            BgImg = _appIndexBgImgJs.BgImg;
        }, function (_appUtilImgJs) {
            checkLoad = _appUtilImgJs.checkLoad;
        }],
        execute: function () {
            'use strict';
            ...
            Hodler = (function () {
                ...
                _createClass(Hodler, [{
                    ...
                    value: function init(data) {
                        ...
                        this.$gotoRight.on('click', function () {
                            var width = $('#lenta_table').width(),
                            ...
                            if (width - window_w + move < 0) {
                                move = window_w - width;
                                _this.$gotoRight.removeClass('hidden').addClass('hidden');
                            }
                            _this.$gotoLeft.removeClass('hidden');
                            _this.$holder.animate({ 'margin-left': move }, "slow");
                        });

                        this.$gotoLeft.on('click', function () {
                            var width = $('#lenta_table').width(),
                                margin_left = parseFloat($('#holder').css('margin-left').replace(/px/ig, '')),
                                window_w = $(window).width() - 52,
                                step = 430,
                            ...
                            if (move > 0) {
                                move = 0;
                                _this.$gotoLeft.removeClass('hidden').addClass('hidden');
                            }
                            _this.$gotoRight.removeClass('hidden');
                            _this.$holder.animate({ 'margin-left': move }, "slow");
                        });
                    }
                }, {
                    key: '__init_tb',
                    value: function __init_tb(data) {
                        var _this2 = this;
                        ...
                        data.forEach(function (x, i) {
                            if (x) {
                                (function () {
                                    ...
                                    var $td = _this2.__new_td(i, x.main_activity.holder_img),
                                        $cell = $('.cell', $td),
                                        $img = $('img', $td),
                                        img = $('img', $td)[0],
                                        $loader = $('.loader', $td);

                                    checkLoad(img, function () {
                                    ...
                                    $cell.data('item', x);
                                    $cell.on('click', _this2.__cell_click);

                                    _this2.__check_goto_btn_stutas();
                                    //if(i === 0){
                                    //    $cell.click();
                                    //}
                                })();
                    ...
                    value: function __cell_click(e) {
                        ...
                        $background_image.animate({ 'opacity': 0 }, 1000, function () {
                            $background_image.remove();
                            $layout.prepend($new_img);
                            var bgImg = new BgImg($(window), $new_img);
                            bgImg.init();
                            $new_img.animate({ 'opacity': 1 }, 2000);
                        });
                    }
                }, {
                    key: '__check_goto_btn_stutas',
                    value: function __check_goto_btn_stutas() {
                        var width = $('#lenta_table').width(),
                            window_w = $(window).width() - 52;
                        if (width < window_w) {
                    ...
                    key: '__new_td',
                    value: function __new_td(id, url) {
            ...
            _export('Hodler', Hodler);
        }
    };
});
System.register('app/index/BgImg.js', ['npm:babel-runtime@5.8.38/helpers/create-class.js', 'npm:babel-runtime@5.8.38/helpers/class-call-check.js', 'npm:jquery@2.2.2.js'], function (_export) {
    var _createClass, _classCallCheck, $, BgImg;
        ...
        execute: function () {
            ...
            BgImg = (function () {
                ...
                _createClass(BgImg, [{
                    ...
                    key: '__set_img_position',
                    value: function __set_img_position() {
                        var _get_coordinate = this.__get_coordinate();

                        var new_img_w = _get_coordinate.new_img_w;
                        var new_img_h = _get_coordinate.new_img_h;
                        var top = _get_coordinate.top;
                        var left = _get_coordinate.left;

                        this.$target.height(new_img_h).width(new_img_w).css({ top: -top, left: -left });
                    }
                }, {
                    key: '__window_resize',
                    value: function __window_resize() {
                        var _this = this;

                        $(window).off('resize').on('resize', function () {
                            _this.__set_img_position();
                        });
                    }
                }, {
                    key: '__get_coordinate',
                    value: function __get_coordinate() {
                        var parent_h = this.$parent.height(),
                            parent_w = this.$parent.width(),
                            img_h = this.$target[0].height,
                            img_w = this.$target[0].width;

                        var new_img_w1 = parent_w,
                            new_img_h1 = img_h / (img_w / parent_w);
                        var new_img_w2 = img_w / (img_h / parent_h),
                            new_img_h2 = parent_h;

                        var is_h_small = new_img_h1 < parent_h,
                            is_w_small = new_img_w2 < parent_w,
                            h_close = new_img_h1 - parent_h,
                            w_close = new_img_w2 - parent_w,
                            is_h_more = h_close > w_close;

                        var new_img_w = new_img_w2,
                        ...
                        return { new_img_w: new_img_w, new_img_h: new_img_h, top: top, left: left };
                    }
                }]);
...
System.register('app/index/Theme.js', ['npm:babel-runtime@5.8.38/helpers/create-class.js', 'npm:babel-runtime@5.8.38/helpers/class-call-check.js', 'npm:jquery@2.2.2.js', 'app/util/img.js'], function (_export) {
    var _createClass, _classCallCheck, $, checkLoad, Theme;
        ...
        execute: function () {
            ...
            Theme = (function () {
                ...
                _createClass(Theme, [{
                    ...
                    key: '__count_money',
                    value: function __count_money() {
                        var count = 0;
                        $('.count-money').each(function (i, item) {
                            var $this = $(item),
                    ...
                    value: function __init_btn() {
                        ...
                        $('.project .btn').on('click', function (e) {
                            ...
                            if ($activityContent.is('#other_activitys')) {
                                ...
                                var $newInput = $('<input type="hidden" id="' + id + '" class="count-money" name="otherActivitys" value="' + id + '">');
                            ...
                            _this2.__count_money();
                        });
                    }
                }, {
                    key: '__init_img',
                    value: function __init_img() {
                        $('img.thumb').each(function (i, img) {
                            var $img = $(img),
...
System.register("app/util/img.js", [], function (_export) {
    "use strict";

    _export("checkLoad", checkLoad);

    function checkLoad(img, callback) {
        if (img.complete) {
...
System.register('app/index_main.js', ['npm:jquery@2.2.2.js', 'app/index/Hodler.js', 'app/index/BgImg.js', 'app/index/Theme.js', 'app/util/img.js'], function (_export) {
    'use strict';

    var $, Hodler, BgImg, Theme, checkLoad;
    return {
        setters: [function (_npmJquery222Js) {
            $ = _npmJquery222Js['default'];
        }, function (_appIndexHodlerJs) {
            Hodler = _appIndexHodlerJs.Hodler;
        }, function (_appIndexBgImgJs) {
            BgImg = _appIndexBgImgJs.BgImg;
        }, function (_appIndexThemeJs) {
            Theme = _appIndexThemeJs.Theme;
        }, function (_appUtilImgJs) {
            checkLoad = _appUtilImgJs.checkLoad;
        }],
        execute: function () {
            ...
            $(function () {
                ...
                if ($background_image.size() > 0) {
                    var img = $background_image[0];
                    checkLoad($background_image[0], function () {
                        var bgImg = new BgImg($(window), $background_image);
                        bgImg.init();
                    });
                }
                ...
                var $lenta = $('#lenta');
                if ($lenta.size() > 0) {
                    $.getJSON(hostPath + '/api/v1/theme/' + $lenta.data('id'), function (json) {
                        if (json) {
                ...
                if ($('.apply-btn').size() > 0) {
                    $('.apply-btn').on('click', function (e) {
                        ...
                        $.post(hostPath + '/api/v1/theme/apply', $form.serialize(), function (json) {
                            if (json) {
                                if (json.stutas === 200 || json.stutas === '200') {
